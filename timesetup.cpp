...
//中英文切换
extern uchar flaglanguage; //中英文切换标志变量。
uchar flagtest;
...
#if 0
            query.exec("select id, name, age from zy");
            while (query.next())
            {
                flagtest = query.value(2).toInt();
            }
...
//        flagtest = 0;
        ...
        ui->pushButton_19->setStyleSheet("QPushButton{border-image:url(./imagejy/zw/english.png);background-repeat: background-xy;background-position: center;background-attachment: fixed;background-clip: padding}");
        //qDebug()<<"flaglanguage = "<<flagtest<<endl;

    }
    else
    {
//        flagtest = 1;
        ui->pushButton_19->setStyleSheet("QPushButton{border-image:url(./imagejy/zw/zw.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding}");
        //qDebug()<<"flaglanguage = "<<flagtest<<endl;
    }
#endif
...
//    else if(flagtest ==1)
//    {
//        ui->pushButton_16->setStyleSheet("QPushButton{border-image:url(./imagejy/zw/anjian222.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding}");
//    }
...
#if 0
void Timesetup::on_pushButton_19_clicked()//中英文设置
{


    //flagtest = 1;
   // qDebug()<<"flaglanguage = "<<flaglanguage<<endl;
#if 1
    if(flagtest)
    {
        flagtest = 0;
...
#if 0
   bool ok = query.exec("create table zy(id INTEGER,name varchar,age INTEGER)");
   if (ok)
   {
       qDebug()<<"ceate table partition success"<<endl;
   }
   else
   {
       qDebug()<<"ceate table partition failed"<<endl;
          ...
          query.prepare("INSERT INTO zy (id, name, age) VALUES (:id, :name, :age)");


          query.bindValue(":id",1);
          query.bindValue(":name", QObject::tr("中英文切换"));
          query.bindValue(":age", flagtest);
          query.exec();
#endif


#if 1
          query.prepare("update zy set age = :age where id = :id");
          query.bindValue(":id",1);
          //query.bindValue(":name", QObject::tr("中英文切换"));
          query.bindValue(":age", flagtest);
          query.exec();
